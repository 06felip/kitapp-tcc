...
<body>
    <nav class="nav-bar">
        ...
        <div class="intro">
            ...
            <p>
                Aqui você vai achar um ambiente perfeito para interagir de maneira objetiva e rápida,
                poderá ver nossas indicações de livros e muito mais!!
            </p>
        </div>
    ...
    <script src="../js/navbar-burguer.js"></script>
